...
class MagazineActionHandler
{
    ...
    public function getMagazineInventory(int $magazineId): array
    {
        ...
        $queries = [
            "SELECT p.name, p.description, SUM(i.qty) as total_quantity, 'parts' as type, p.id as item_id
            ...
            "SELECT s.name, s.description, SUM(i.qty) as total_quantity, 'smd' as type, s.id as item_id
            ...
            "SELECT t.name, t.description, SUM(i.qty) as total_quantity, 'tht' as type, t.id as item_id
            ...
            "SELECT s.name, s.description, SUM(i.qty) as total_quantity, 'sku' as type, s.id as item_id
