...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 01, 2026 at 11:43 AM
...
--
-- Table structure for table `bom__flat`
--
...
--
-- Table structure for table `bom__sku`
--
...
--
-- Table structure for table `bom__smd`
--
...
--
-- Table structure for table `bom__tht`
--
...
--
-- Table structure for table `commission__list`
--
...
--
-- Table structure for table `commission__receivers`
--
...
--
-- Table structure for table `group__contractors`
--
...
--
-- Table structure for table `group__list`
--
...
--
-- Table structure for table `inventory__input_type`
--
...
--
-- Table structure for table `inventory__parts`
--
...
--
-- Table structure for table `inventory__sku`
--
...
--
-- Table structure for table `inventory__smd`
--
...
--
-- Table structure for table `inventory__tht`
--
...
--
-- Table structure for table `inventory__transfer_groups`
--
...
--
-- Table structure for table `list__laminate`
--
...
--
-- Table structure for table `list__parts`
--
...
--
-- Table structure for table `list__smd`
--
...
CREATE TABLE `list__smd` (
  ...
  `description` text NOT NULL,
  `isActive` tinyint(1) NOT NULL DEFAULT 1,
  `default_bom_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Table structure for table `list__tht`
--
...
--
-- Table structure for table `list__vendor_part_pack`
--
...
--
-- Table structure for table `lowstock__parts`
--
...
--
-- Table structure for table `lowstock__sku`
--
...
--
-- Table structure for table `lowstock__smd`
--
...
--
-- Table structure for table `lowstock__tht`
--
...
--
-- Table structure for table `magazine__list`
--
...
--
-- Table structure for table `magazine__type`
--
...
--
-- Table structure for table `notification__action_needed`
--
...
--
-- Table structure for table `notification__flowpin_query_type`
--
...
--
-- Table structure for table `notification__list`
--
...
--
-- Table structure for table `notification__queries_affected`
--
...
--
-- Table structure for table `notification__receivers`
--
...
--
-- Table structure for table `part__group`
--
...
--
-- Table structure for table `part__type`
--
...
--
-- Table structure for table `part__unit`
--
...
--
-- Table structure for table `ref__flowpin_update_progress`
--
...
--
-- Table structure for table `ref__package_exclude`
--
...
--
-- Table structure for table `ref__timestamp`
--
...
--
-- Table structure for table `ref__transfer_group_types`
--
...
--
-- Table structure for table `ref__valuepackage`
--
...
--
-- Table structure for table `used__sku`
--
...
--
-- Table structure for table `used__smd`
--
...
--
-- Table structure for table `used__tht`
--
...
--
-- Indexes for table `commission__list`
--
ALTER TABLE `commission__list`
  ...
  ADD KEY `idx_state_cancelled` (`state`,`is_cancelled`);

--
-- Indexes for table `commission__receivers`
--
...
--
-- Indexes for table `group__contractors`
--
...
--
-- Indexes for table `group__list`
--
ALTER TABLE `group__list`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `inventory__input_type`
--
ALTER TABLE `inventory__input_type`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `inventory__parts`
--
ALTER TABLE `inventory__parts`
  ...
  ADD KEY `idx_tg_submag` (`transfer_group_id`,`sub_magazine_id`),
  ADD KEY `idx_tg_input` (`transfer_group_id`,`input_type_id`),
  ADD KEY `idx_tg_device` (`transfer_group_id`,`parts_id`),
  ADD KEY `idx_tg_summary` (`transfer_group_id`,`is_cancelled`,`parts_id`,`qty`),
  ADD KEY `idx_ts_cancelled` (`timestamp`,`is_cancelled`),
  ADD KEY `idx_tg_cancelled_ts` (`transfer_group_id`,`is_cancelled`,`timestamp`),
  ADD KEY `idx_commission_id` (`commission_id`);

--
-- Indexes for table `inventory__sku`
--
ALTER TABLE `inventory__sku`
  ...
  ADD KEY `idx_tg_submag` (`transfer_group_id`,`sub_magazine_id`),
  ADD KEY `idx_tg_input` (`transfer_group_id`,`input_type_id`),
  ADD KEY `idx_tg_device` (`transfer_group_id`,`sku_id`),
  ADD KEY `idx_tg_summary` (`transfer_group_id`,`is_cancelled`,`sku_id`,`qty`),
  ADD KEY `idx_ts_cancelled` (`timestamp`,`is_cancelled`),
  ADD KEY `idx_tg_cancelled_ts` (`transfer_group_id`,`is_cancelled`,`timestamp`),
  ADD KEY `idx_commission_id` (`commission_id`);

--
-- Indexes for table `inventory__smd`
--
ALTER TABLE `inventory__smd`
  ...
  ADD KEY `idx_tg_submag` (`transfer_group_id`,`sub_magazine_id`),
  ADD KEY `idx_tg_input` (`transfer_group_id`,`input_type_id`),
  ADD KEY `idx_tg_device` (`transfer_group_id`,`smd_id`),
  ADD KEY `idx_tg_summary` (`transfer_group_id`,`is_cancelled`,`smd_id`,`qty`),
  ADD KEY `idx_ts_cancelled` (`timestamp`,`is_cancelled`),
  ADD KEY `idx_tg_cancelled_ts` (`transfer_group_id`,`is_cancelled`,`timestamp`),
  ADD KEY `idx_commission_id` (`commission_id`);

--
-- Indexes for table `inventory__tht`
--
ALTER TABLE `inventory__tht`
  ...
  ADD KEY `idx_tg_submag` (`transfer_group_id`,`sub_magazine_id`),
  ADD KEY `idx_tg_input` (`transfer_group_id`,`input_type_id`),
  ADD KEY `idx_tg_device` (`transfer_group_id`,`tht_id`),
  ADD KEY `idx_tg_summary` (`transfer_group_id`,`is_cancelled`,`tht_id`,`qty`),
  ADD KEY `idx_ts_cancelled` (`timestamp`,`is_cancelled`),
  ADD KEY `idx_tg_cancelled_ts` (`transfer_group_id`,`is_cancelled`,`timestamp`),
  ADD KEY `idx_commission_id` (`commission_id`);

--
-- Indexes for table `inventory__transfer_groups`
--
ALTER TABLE `inventory__transfer_groups`
  ...
  ADD KEY `idx_created_by_at` (`created_by`,`created_at`),
  ADD KEY `idx_type_id` (`type_id`);

--
-- Indexes for table `list__laminate`
--
ALTER TABLE `list__laminate`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `list__parts`
--
...
--
-- Indexes for table `list__vendor_part_pack`
--
ALTER TABLE `list__vendor_part_pack`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_vp_pack` (`vendor_part_id`,`full_pack_quantity`),
  ADD KEY `idx_vpp_vp` (`vendor_part_id`);
...
--
-- Indexes for table `magazine__type`
--
ALTER TABLE `magazine__type`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `notification__action_needed`
--
ALTER TABLE `notification__action_needed`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `notification__flowpin_query_type`
--
ALTER TABLE `notification__flowpin_query_type`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `notification__list`
--
...
--
-- Indexes for table `notification__queries_affected`
--
...
--
-- Indexes for table `notification__receivers`
--
ALTER TABLE `notification__receivers`
  ADD PRIMARY KEY (`notification_id`,`user_id`);

--
-- Indexes for table `part__group`
--
ALTER TABLE `part__group`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `part__type`
--
ALTER TABLE `part__type`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `part__unit`
--
ALTER TABLE `part__unit`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `purchase__number_counter`
--
ALTER TABLE `purchase__number_counter`
  ADD PRIMARY KEY (`year`,`type`);

--
-- Indexes for table `purchase__order`
--
ALTER TABLE `purchase__order`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_po_vendor` (`vendor_id`),
  ADD KEY `idx_po_state` (`state`),
  ADD KEY `fk_po_user` (`created_by`),
  ADD KEY `fk_po_rfq` (`converted_from_rfq_id`);

--
-- Indexes for table `purchase__order_item`
--
ALTER TABLE `purchase__order_item`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_poi_po` (`po_id`),
  ADD KEY `fk_poi_vp` (`vendor_part_id`),
  ADD KEY `fk_poi_unit` (`quantity_unit_id`);

--
-- Indexes for table `purchase__order_receipt`
--
...
--
-- Indexes for table `purchase__order_receipt_item`
--
ALTER TABLE `purchase__order_receipt_item`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_receipt_item_receipt` (`receipt_id`),
  ADD KEY `idx_receipt_item_po_item` (`po_item_id`),
  ADD KEY `fk_receipt_item_mag` (`sub_magazine_id`);

--
-- Indexes for table `purchase__rfq`
--
ALTER TABLE `purchase__rfq`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_rfq_vendor` (`vendor_id`),
  ADD KEY `idx_rfq_state` (`state`),
  ADD KEY `fk_rfq_user` (`created_by`);

--
-- Indexes for table `purchase__rfq_item`
--
ALTER TABLE `purchase__rfq_item`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_rfq_item_rfq` (`rfq_id`),
  ADD KEY `fk_rfq_item_vp` (`vendor_part_id`),
  ADD KEY `fk_rfq_item_unit` (`quantity_unit_id`);

--
-- Indexes for table `ref__flowpin_checkpoints`
--
ALTER TABLE `ref__flowpin_checkpoints`
  ADD PRIMARY KEY (`operation_type`);

--
-- Indexes for table `ref__flowpin_update_progress`
--
...
--
-- Indexes for table `ref__package_exclude`
--
ALTER TABLE `ref__package_exclude`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ref__timestamp`
--
ALTER TABLE `ref__timestamp`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ref__transfer_group_types`
--
...
--
-- Indexes for table `ref__valuepackage`
--
...
--
-- AUTO_INCREMENT for table `list__vendor`
--
ALTER TABLE `list__vendor`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `list__vendor_part`
--
ALTER TABLE `list__vendor_part`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `list__vendor_part_pack`
--
ALTER TABLE `list__vendor_part_pack`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `list__vendor_supplier`
--
ALTER TABLE `list__vendor_supplier`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `list__vendor_part_pack`
--
ALTER TABLE `list__vendor_part_pack`
  ADD CONSTRAINT `fk_vpp_vendor_part` FOREIGN KEY (`vendor_part_id`) REFERENCES `list__vendor_part` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
