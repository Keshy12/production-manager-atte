...
<div class="container mt-4">
    <h1 class="mb-4">
        <i class="bi bi-cloud-download mr-2"></i>Flowpin - Synchronizacja Danych
    </h1>

    <ul class="nav nav-tabs mb-4" id="flowpinTabs" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" id="update-tab" data-toggle="tab" href="#update" role="tab">Aktualizacja</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" id="sessions-tab" data-toggle="tab" href="#sessions" role="tab">Sesje</a>
        </li>
    </ul>

    <div class="tab-content" id="flowpinTabContent">
        ...
        <div class="tab-pane fade" id="sessions" role="tabpanel">
            <div class="container-fluid mt-4">
                <h2><i class="bi bi-clock-history mr-2"></i> Historia Sesji Aktualizacji FlowPin</h2>
...
<?php include __DIR__ . '/sessions/modals.php'; ?>
...
<script src="<?= asset('public_html/components/Admin/synchronization/flowpin/update/flowpin-update.js') ?>"></script>
<script src="<?= asset('public_html/components/Admin/synchronization/flowpin/sessions/flowpin-sessions-view.js') ?>"></script>