        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6" id="vendorCell">
                    ...
                    <select id="vendorSelect" class="selectpicker form-control" data-live-search="true" data-width="400px" data-container="#vendorCell" title="Wybierz dostawcę...">
                ...
                <div class="col-md-6" id="partCell">
                    ...
                    <select id="partSelect" class="selectpicker form-control" data-live-search="true" data-width="400px" data-container="#partCell" title="Wybierz część...">
                ...
                <div class="col-md-4" id="vendorPartCell">
                    ...
                    <div class="d-flex align-items-start">
                        <div class="flex-grow-1 mr-1">
                            <select id="vendorPartNoSelect" class="selectpicker form-control" data-live-search="true" data-width="200px" data-container="#vendorPartCell" title="Wybierz numer u dostawcy...">
